...
- The ONLY sanctioned exit from a red PR that won't converge is [[feedback-fail-gracefully-timebox]]: after ~3 honest fix attempts, mark the PR draft with the blocker documented, hand the issue back to triage, and move on — "stop everything" means no gate-skipping, not an infinite grind.
