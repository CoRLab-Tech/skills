...
- The PR body justifies the addition in one line: what it does, why in-repo alternatives don't fit, and the audit result. The security gate ([[feedback-pr-gate-passes]]) double-checks it.
